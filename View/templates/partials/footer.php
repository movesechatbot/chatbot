...
<body>
    <div class="container-fluid" style="background-color: rgb(95, 13, 13); padding-left: 15%; padding-right: 15%;">
        <footer class="py-5 mt-5">
            ...
            <p class="text-center text-light">© 2025 Théo Vitor Tavora, Movese Inc</p>
        </footer>
    </div>
</body>
</html>